...
# 일본 애니메이션풍 3D 캐릭터를 표현하기 위한 연구

일본 애니메이션풍의 카툰 렌더링 3D캐릭터를 표현하기 위해 연구한 내용들 입니다.

더 나은 애니메이션풍의 3D캐릭터 표현을 위해서 다음과 같은 부분을 연구했습니다.
1. 유니티 셰이더
2. 유니티 커스텀 스크립트
3. 3D 모델링
4. 리깅
...
개인적으로 가장 최애하면서, 치마를 올려 입는 하이웨이스트 스타일이 취향이기 때문에 기존 디자인을 수정하여 모델링으로 만들고 유니티에 올려보기로 했습니다.(위의 이미지는 지인에게 디자인 조언을 들으며 제공받은 그림입니다.)
